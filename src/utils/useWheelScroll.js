 ...
 *
 * @param {RefObject<Element>} ref - Ref of the Element to attach listener to
 * @param {MotionValue<number>} y - MotionValue for the scrollable element - might be different to the Element
 * @param {Constraints | null} constraints - top/bottom scroll constraints in pixels.
 * @param {(e: WheelEvent) => void} onWheelCallback
 * @param {boolean} isActive - `true` if this listener should fire.
 */
